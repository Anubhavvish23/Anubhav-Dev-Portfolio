      ...
      <div className="text-center space-y-16 relative z-10">
        ...
        <div className="logo-container">
          ...
          >
            {/* A */}
            <path
              d="M20 90 L30 60 L40 90 M25 75 L35 75 M30 45 L15 90 M30 45 L45 90"
              stroke="currentColor"
              strokeWidth="3"
              strokeLinecap="round"
            ...
            {/* S */}
            <path
              d="M85 60 C85 55, 80 50, 75 50 L65 50 C60 50, 55 55, 55 60 C55 65, 60 70, 65 70 L75 70 C80 70, 85 75, 85 80 C85 85, 80 90, 75 90 L65 90 C60 90, 55 85, 55 80"
              stroke="currentColor"
              strokeWidth="3"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <div className="space-y-6">
          <h1 className="text-2xl font-light text-white tracking-[0.3em] opacity-80">
            ANUBHAV S
          </h1>
